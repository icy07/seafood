...
function initSliders() {
	...
	if (document.querySelector(".hero__main-slider")) new Swiper(".hero__main-slider", {
		modules: [Navigation, Pagination],
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		...
		speed: 600,
		pagination: {
			el: ".hero__main-pagination",
			clickable: true
		},
		navigation: {
			prevEl: ".hero__main-btn-prev",
			nextEl: ".hero__main-btn-next"
		}
	});
	document.querySelectorAll(".slider__slider").forEach((sliderEl) => {
		const section = sliderEl.closest(".slider");
		new Swiper(sliderEl, {
			modules: [Navigation, Pagination],
			observer: true,
			observeParents: true,
			...
			speed: 400,
			pagination: {
				el: section.querySelector(".slider__pagination"),
				clickable: true
			},
			navigation: {
				prevEl: section.querySelector(".slider__slider-btn-prev"),
				nextEl: section.querySelector(".slider__slider-btn-next")
			},
			breakpoints: {
				320: { slidesPerView: 1 },
				600: { slidesPerView: 2 },
...
* Version: 5.0.9
*/
/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ (/* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
...
//#endregion
export { slideToggle as a, gotoBlock as i, bodyUnlock as n, slideUp as o, getHash as r, formValidate as t };
